...
<div class="row gg">
    ...
    <div class="col-md-3">
        <ul id="tabs" class=" nav-tab bg-white" data-tabs="tabs">
            <li class="active">
                <a href="#tab1" data-toggle="tab"><i class="fa fa-tasks"></i> <span class="tab-names">Overview</span></a>
            </li>
            <li>
        ...
        <div class="tab-pane active" id="tab1">
            <div class="row">
               ...
               <div class="col-lg-4 col-sm-6 col-md-4">
                    <div class="db-overview ts">
                        <div class="db-icon">
                            <i class="fa fa-user fa-3x"></i>
                        </div>
                        <div class="db-info">
                           <a href="#"> <span>Email:  sanzid@live.com</span> </a>
                           <a href="#"> <span class="coral">Edit</span></a>  
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 col-md-4">
                    <div class="db-overview ts">
                        ...
                        <div class="db-info">
                           <a href="#"> <span>Accounts: 0</span> </a>
                           <a href="#"> <span class="coral">Add broker account</span></a>  
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 col-md-4">
                    <div class="db-overview ts">
                        ...
                        <div class="db-info">
                           <a href="#"> <span>Last:  no transactions</span> </a>
                           <a href="#"> <span class="coral">Edit</span></a>  
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 col-md-4">
                    <div class="db-overview ts">
                        ...
                        <div class="db-info">
                           <a href="#"> <span>My clients: 0</span> </a>
                           <a href="#"> <span class="coral">My Links</span></a>  
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 col-md-4">
                    <div class="db-overview ts">
                        ...
                        <div class="db-info">
                           <a href="#"> <span>Total amount: $0.00</span> </a>
                           <a href="#"> <span class="coral">Edit</span></a>  
                        </div>
                    </div>
                </div>
